...
public class ProfileController {
    ...
    public String profile(Model model, Authentication authentication) {
        ...
        model.addAttribute("updateProfileDto", new UpdateProfileDto(user.getEmail(), user.getUsername(), user.getFirstName(), user.getLastName(), user.getGender(), user.getBirthday(), user.getBio()));
